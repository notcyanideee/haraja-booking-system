...
<body class="dark-mode">
    <div class="main-content">
        ...
        <div class="manage-grid" style="display: flex; gap: 2rem;">
        ...
        <div class="modal-box">
            ...
            <form action="manage.php" method="POST">
                ...
                <div style="display: flex; gap: 1rem;">
                    <div class="form-group" style="flex: 1;">
                        <label>Check In</label>
                        <input type="text" name="check_in" id="edit_check_in" class="form-control" required>
                    </div>
                    <div class="form-group" style="flex: 1;">
                        <label>Check Out</label>
                        <input type="text" name="check_out" id="edit_check_out" class="form-control" required>
                    </div>
                    <div class="form-group" style="flex: 1;">
                        <label>Total (₱)</label>
    ...
    <div class="modal-overlay" id="deleteModal">
        <div class="modal-box" style="max-width: 420px; text-align: center;">
            ...
            <p style="margin-bottom: 1.5rem; opacity: 0.9;">
                Are you sure you want to delete the booking for <strong id="delete_booking_title" style="color: goldenrod;"></strong>? This action cannot be undone.
            </p>
            <form action="manage.php" method="POST">
